...
//Consult
Route::get('/consult', [ConsultController::class, 'consultfun'])->middleware("auth");
...
Route::get("/getdatamanage/{input}", [ManageProductController::class, "managesearch"])->name('manage.search');
...
//Demo
Route::get('/demo',[IndexController::class,'demofun']);